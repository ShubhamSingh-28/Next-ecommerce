      ...
      <div className="mt-8">
        <ul className="space-y-4">
          ...
          <div className="flex flex-1 items-center justify-end gap-2">
              <h2 htmlFor="Line1Qty" className="sr-only"> Quantity </h2>

              <div
                className="h-8 w-12 rounded border-gray-200 bg-gray-50  text-center text-lg text-gray-600 [-moz-appearance:_textfield] focus:outline-none [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none"
              >{p.quantity}</div>
